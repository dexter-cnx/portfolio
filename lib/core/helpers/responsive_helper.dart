...
extension ResponsiveHelper on BuildContext {
  ...
  double get sectionPaddingH =>
      responsive(mobile: 20.0, tablet: 40.0, desktop: 24.0);

  /// Hero font size for the main headline.
  double get heroFontSize =>
      responsive(mobile: 44.0, tablet: 60.0, desktop: 80.0);

  /// Section title font size.
  double get sectionTitleSize =>
      responsive(mobile: 22.0, tablet: 26.0, desktop: 28.0);
